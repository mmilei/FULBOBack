...
public class Proyecto {
    ...
    public Proyecto(int codigo, String nombre, String fechaInicio, String fechaFinal, String lider, String estadoDescripcion, String calificacionPendiente) {
        this.codigo = codigo;
        this.nombre = nombre;
    ...
    public Proyecto(int codigo, String nombre, String nombreAbreviado, String fechaInicio, String fechaFinal, String profesionalVenta, String lider, Integer estado, String estadoDescripcion, String clase) {
        this.codigo = codigo;
        this.nombre = nombre;
